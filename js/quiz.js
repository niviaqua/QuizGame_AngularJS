...
"use strict";
    ...
    app.controller('QuizController', ['$scope', '$http', '$sce', function ($scope, $http, $sce){
        ...
        $scope.createShareLinks = function(percentage) {
            ...
            var emailLink = '<a class="btn email" ' +
                'href="mailto:?subject=Try to beat me in this?&amp;body=This is my best score in Saturn test. Try to beat my score at '+percentage+'%. Play more at '+url+'">Email a friend</a>';
